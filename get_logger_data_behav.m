function get_logger_data_behav(Audio_dir, Loggers_dir, Date, ExpStartTime, varargin)
...
% uses the output of these last codes, voc_transc_time, to extract
...
%% Load the manual coding of bahevior
