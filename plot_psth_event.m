function plot_psth_event(Loggers_dir, Date, ExpStartTime, AudioLoggerID, NeuroLoggerID)
...
%         end
        ...
        hold on
        yyaxis right
        plot(Psth_KDEfiltered_VocCall_t{cc,uu}, Psth_KDEfiltered_VocCall{cc,uu}/max(Psth_KDEfiltered_TVocCall_scalef(:,uu))+cc-1, 'r-', 'LineWidth',2)
    end
    yyaxis left
    xlabel('Time centered at production onset (ms)')
    ylim([0 VocCall+1])
